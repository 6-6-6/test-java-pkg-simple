...
# Skeleton command:
# java-ebuilder --generate-ebuild --workdir . --pom animal-sniffer-animal-sniffer-parent-1.19/animal-sniffer/pom.xml --download-uri https://github.com/mojohaus/animal-sniffer/archive/animal-sniffer-parent-1.19.tar.gz --slot 0 --keywords "~amd64" --ebuild animal-sniffer-1.19.ebuild
...
# Common dependencies
# POM: ${PN}-${PN}-parent-${PV}/${PN}/pom.xml
